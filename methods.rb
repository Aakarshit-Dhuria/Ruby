def multiply(first_number, second_number)
    first_number.to_f * second_number.to_f # last statement is autonmatically returned from the function
end
...
puts "The first number mod the second number is: #{modulo(first_number, second_number)}"